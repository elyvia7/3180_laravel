    ...
    <div class="grid grid-cols-1 gap-8">
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            ...
            <div class="flex gap-6 items-start">
                ...
                ? asset('storage/' . $event->poster_path): 'https://placehold.co/200x200' }}"
            ...
            <form action="{{ route('checkout.store', $event->id) }}"
                ...
                <div>
                    ...
                    <input type="text" name="customer_name"
                        ...
                        class="w-full px-5 py-4 bg-white border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo500/10 focus:border-indigo-600 outline-none transition fontmedium"
                        required value="{{ old('customer_name') }}">
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-bold textslate-700 mb-2 uppercase tracking-wide">Email Aktif</label>
                        <input type="email" name="customer_email"
                            placeholder="contoh@gmail.com"
                            class="w-full px-5 py-4 bg-white border2 border-slate-100 rounded-2xl focus:ring-4 focus:ringindigo-500/10 focus:border-indigo-600 outline-none transition font-medium"
